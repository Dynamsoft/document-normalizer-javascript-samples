        ...
        return (
            <div>
                <div className="video-normalizer-btns">
                    <button className="editor-border-btn" onClick={this.confirmQuadForNormalization}>Edit quadrilateral</button>
                    <button className="end-editor-btn" onClick={this.normalizeWithConfirmedQuad}>Normalize</button>
                </div>
                ...
                <div className="video-normalized-result" ref={this.elVnr}></div>
            </div>
