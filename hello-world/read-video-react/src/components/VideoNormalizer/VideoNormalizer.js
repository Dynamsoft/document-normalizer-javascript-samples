...
export default class VideoNormalizer extends React.Component {
    constructor(props) {
        super(props);
        this.pCameraEnhancer = null;
        this.pNormalizer = null;
        this.elRef = React.createRef();
        this.elVnr = React.createRef();
    }
    async componentDidMount() {
        try {
            ...
            await this.pCameraEnhancer.setUIElement(this.elRef.current);

            this.pNormalizer.onQuadDetected = async (results, sourceImage) => {
                console.log(results);
            }
    ...
    normalizeWithConfirmedQuad = async () => {
        try {
            ...
            this.elVnr.current.appendChild(cvs);
            console.log(res);
        } catch(ex) {
            alert(ex.message || ex)
        }
    ...
    shouldComponentUpdate(){
        // Never update UI after mount, ddnjs sdk use native way to bind event, update will remove it.
        return false;
    }
    render() {
        return (
            <div>
                <div className="video-normalizer-btns">
                    <button className="editor-border-btn" onClick={this.confirmQuadForNormalization}>confirmQuadForNormalization</button>
                    <button className="end-editor-btn" onClick={this.normalizeWithConfirmedQuad}>normalizeWithConfirmedQuad</button>
                </div>
                <div ref={this.elRef} className="component-document-normalizer">
                ...
                <div className="video-normalize-result" ref={this.elVnr}></div>
            </div>
