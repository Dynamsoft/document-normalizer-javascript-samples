        ...
        return (
            <div>
                <div className="video-normalizer-btns">
                    <button className="editor-border-btn" onClick={this.confirmQuadForNormalization}>Editor</button>
                    <button className="end-editor-btn" onClick={this.normalizeWithConfirmedQuad}>End Editor</button>
                </div>
